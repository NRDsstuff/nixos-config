...

{
  ...
  services.syncthing.settings.devices = {
    ...
    "jabe tefaxyn" = { id = "DRBCWGK-IEMEJUT-7UDIOKI-L43OVYB-ABUZJZW-25ITEDF-H3QM6D2-4OLNZA7"; };
    "lennie tul" = { id = "TGR22FT-KMT2W5Z-RWVVHHV-PPA4K56-AMDQGUB-DR5H27H-55TTE7R-2BBHLAF"; };
    "ralue proseros" = { id = "COX76TO-46KCILR-NWHIUSX-OSD26HN-7CNEQQS-BE6R2IU-LWPUGM7-7ZJZSQ3"; };
  ...
  services.syncthing.settings.folders = {
    "music" = {
      id = "kny7f-c7wwf";
      path = "/home/nrd/Music";
      devices = [ "jabe tefaxyn" "jabe tablet" ];
    };
    "rift" = {
      id = "67ae6-9wxmy";
      path = "/home/nrd/Rift";
    ...
    "obsidian ixni" = {
      ...
      devices = [ "jabe tefaxyn" "ralue tefaxyn" "ralue proseros" "jabe tablet" ];
    };
    "anax kulup" = {
      id = "ejzvn-jtuie";
