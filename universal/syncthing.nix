...

{
    ...
    services.syncthing.settings.devices = {
        ...
        "jabe tefaxyn" = { id = "IU6WR7O-YBX6VLR-RRMSVQI-UADTZRX-RWOP4C7-FDMFMSD-KDUMY3E-5JA7TQX"; };
        ...
        "jabe quest" = { id = "F6YQGXO-AC2JQXK-E7H7NLM-H4UW7LV-VX4W5PI-ZZNUD2W-6C2VSJY-HI4BJQL"; };
        # <3
